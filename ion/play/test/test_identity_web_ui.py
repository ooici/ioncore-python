...
<INPUT TYPE="submit" NAME="search" VALUE="Search" /><p/>
        ...
        post = 'search=Search&name=&rsa_private_key=&certificate=&' + \
...
<INPUT TYPE="submit" NAME="search" VALUE="Search" /><INPUT TYPE="submit" NAME="update" VALUE="Update" /><input type="submit" name="clear" value="Clear"><p/>
        ...
        post = 'update=Update&name=Roger+Unwin&rsa_private_key=changed_test&certificate=changed_test&' + \
        ...
        actual_update_user_result = yield client.getPage("http://localhost:9001/find_user?" + post) #8999
