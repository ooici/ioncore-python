...
GET_RESOURCE_REQUEST_MESSAGE_TYPE = object_utils.create_type_identifier(object_id=55, version=1)
RESOURCE_REPLY_MESSAGE_TYPE = object_utils.create_type_identifier(object_id=56, version=1)
